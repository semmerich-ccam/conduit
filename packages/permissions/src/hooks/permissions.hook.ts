/**
 * Based off of expos permission hooks
 */
...
type RequestPermissionMethod<Permission extends ICC_PERMISSION_RESPONSE> = () => Promise<Permission>;
type GetPermissionMethod<Permission extends ICC_PERMISSION_RESPONSE> = () => Promise<Permission>;

interface PermissionHookMethods<Permission extends ICC_PERMISSION_RESPONSE, Options = never> {
 ...
 */
function usePermission<Permission extends ICC_PERMISSION_RESPONSE, Options extends object>(
 ...
 */
export function createPermissionHook<Permission extends ICC_PERMISSION_RESPONSE, Options extends object>(
  methods: PermissionHookMethods<Permission, Options>
) {
